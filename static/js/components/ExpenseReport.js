class ExpenseReport {
                ...
                <div class="col-md-4 mb-3">
                  <div class="card bg-secondary text-white">
                    <div class="card-body text-center">
                      ...
                      <h3 id="report-total-expenses">$0.00</h3>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
                  <div class="card bg-secondary text-white">
                    <div class="card-body text-center">
                      ...
                      <h3 id="report-average-expense">$0.00</h3>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 mb-3">
  ...
  update(reports, categories) {
    ...
    document.getElementById('report-total-expenses').textContent = `$${this.formatCurrency(summary.total || 0)}`;
    document.getElementById('report-average-expense').textContent = `$${this.formatCurrency(summary.average || 0)}`;
    ...
    tableBody.innerHTML = sortedCategories.map(category => {
      ...
      return `
        <tr>
          ...
          <td>$${this.formatCurrency(category.total)}</td>
          <td>
